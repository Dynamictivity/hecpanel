...
<ul class="mainnav-menu">
	<li class="dropdown active">
		...
		<ul class="dropdown-menu" role="menu">
			<li>
				<?php echo $this->Html->link('<i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;' . __('List Instances'), array('controller' => 'instances', 'action' => 'index', 'admin' => true, 'plugin' => 'instances'), array('escape' => false)); ?></li>
			</li>
			<li>
				<?php echo $this->Html->link('<i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;' . __('Instance Profiles'), array('controller' => 'instance_profiles', 'action' => 'index', 'admin' => true, 'plugin' => 'instances'), array('escape' => false)); ?></li>
			</li>
			<li>
			...
			<li>
				<?php echo $this->Html->link('<i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;' . __('Memory Logs'), array('controller' => 'memory_logs', 'action' => 'index', 'admin' => true, 'plugin' => 'instances'), array('escape' => false)); ?></li>
			</li>
			<li>
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu">
			<li>
				<?php echo $this->Html->link('<i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;' . __('List Products'), array('controller' => 'products', 'action' => 'index', 'admin' => true, 'plugin' => 'shop'), array('escape' => false)); ?></li>
			</li>
		</ul>
	</li>
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu">
			<li>
				<?php echo $this->Html->link('<i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;' . __('List Feedback'), array('controller' => 'feedback', 'action' => 'index', 'admin' => true, 'plugin' => 'support'), array('escape' => false)); ?></li>
			</li>
		</ul>
	</li>
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu">
			...
			<li>
				<?php echo $this->Html->link('<i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;' . __('List Devlogs'), array('controller' => 'devlogs', 'action' => 'index', 'admin' => true, 'plugin' => false), array('escape' => false)); ?></li>
			</li>
			<li>
