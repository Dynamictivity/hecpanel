...
<?php
echo $this->Form->create('InstanceType', array(
	'class' => 'well form-horizontal'
));
?>
<fieldset>
	<legend><?php echo __('Admin Edit Instance Type'); ?></legend>
	<?php
	...
	echo $this->Form->input('auto_save_in_minutes');
	...
	echo $this->Form->input('pause_game_when_empty');
	echo $this->Form->input('ignore_last_session');
	?>
</fieldset>
